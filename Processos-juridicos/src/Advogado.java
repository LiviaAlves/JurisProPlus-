...
public class Advogado extends Pessoa implements Informações{
    ...
    public Processo NovoProcesso(float numProcesso, String titulo, String tipo, LocalDate inicio, String status, String partesEnvolvidas, LocalDate prazo) {
    ...
    public List<LocalDate> getPrazosDosProcessos() {
        List<LocalDate> prazos = new ArrayList<>();
